...
export function handleToolCall(db: Database.Database, name: string, args: Record<string, unknown>) {
  switch (name) {
    case 'search_eu_law':
      return searchEuLaw(db, args as any);
    case 'get_article':
      return getArticle(db, args as any);
    case 'get_regulation':
      return getRegulation(db, args as any);
    case 'get_directive':
      return getDirective(db, args as any);
    case 'get_case_law':
      return getCaseLaw(db, args as any);
    case 'list_sources':
    ...
    case 'get_transposition_status':
      return getTranspositionStatus(db, args as any);
    case 'get_regulatory_technical_standard':
      return getRegulatoryTechnicalStandard(db, args as any);
    case 'get_commission_proposal':
      return getCommissionProposal(db, args as any);
    case 'search_case_law':
      return searchCaseLaw(db, args as any);
