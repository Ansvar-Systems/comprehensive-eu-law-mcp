...
export function seedCharter(db: Database.Database): void {
  ...
  const { lastInsertRowid: actId } = insertAct.run(
    'Charter of Fundamental Rights of the European Union',
    'EU Charter', '12012P/TXT', 'treaty',
    'OJ C 326, 26.10.2012',
    '2000-12-07', '2009-12-01', 'in_force',
    'Fundamental rights; human dignity; freedoms; equality; solidarity; citizens rights; justice',
    null,
